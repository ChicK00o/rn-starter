...
export const getSize = (screenSize, props) => {
    switch (screenSize) {
        case 'sm':
            if (
                props.smSize !== undefined ||
                props.smSizePoints !== undefined
            ) {
        ...
        case 'lg':
            if (
                props.lgSize !== undefined ||
                props.lgSizePoints !== undefined
            ) {
        ...
        case 'xl':
            if (
                props.xlSize !== undefined ||
                props.xlSizePoints !== undefined
            ) {
...
export const getOffset = (screenSize, props) => {
    switch (screenSize) {
        ...
        case 'md':
            if (
                props.mdOffset !== undefined ||
                props.mdOffsetPoints !== undefined
            ) {
        ...
        case 'lg':
            if (
                props.lgOffset !== undefined ||
                props.lgOffsetPoints !== undefined
            ) {
        ...
        case 'xl':
            if (
                props.xlOffset !== undefined ||
                props.xlOffsetPoints !== undefined
            ) {
